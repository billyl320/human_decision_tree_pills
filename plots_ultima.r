...
ggsave(filename="plots/circ_ecc.png", plot=scat,
       width=9, height=7)
...
ggsave(filename="plots/sp_ecc.png", plot=scat,
       width=9, height=7)
...
ggsave(filename="plots/e1_e2.png", plot=scat,
       width=9, height=7)
...
ggsave(filename="plots/corn_ecc.png", plot=scat,
       width=9, height=7)
